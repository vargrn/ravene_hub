-- Idempotent guard migration: keeps account login working after replacing PayPal billing with MoonPay Commerce.
-- Safe to apply even if 0004/0005 already created these tables.
