...
// .wrangler/tmp/pages-2AuX7t/bundledWorker-0.44270293637621116.mjs
...
__name2(isShareablePostPage, "isShareablePostPage");
...
__name2(postSlugFromPageURL, "postSlugFromPageURL");
...
__name2(canonicalPostSlug, "canonicalPostSlug");
...
__name2(postLookupSlugs, "postLookupSlugs");
...
__name2(serveShareablePostPage, "serveShareablePostPage");
...
__name2(loadSharePostPreview, "loadSharePostPreview");
...
__name2(fallbackSharePostPreview, "fallbackSharePostPreview");
...
__name2(sharePreviewImage, "sharePreviewImage");
...
__name2(injectSharePreviewMeta, "injectSharePreviewMeta");
...
__name2(absoluteShareUrl, "absoluteShareUrl");
...
__name2(shareDescription, "shareDescription");
function escapeHtmlText(value) {
  return String(value ?? "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
}
__name(escapeHtmlText, "escapeHtmlText");
__name2(escapeHtmlText, "escapeHtmlText");
function escapeHtmlAttribute(value) {
  return escapeHtmlText(value).replace(/"/g, "&quot;").replace(/'/g, "&#039;");
}
__name(escapeHtmlAttribute, "escapeHtmlAttribute");
__name2(escapeHtmlAttribute, "escapeHtmlAttribute");
...
__name2(currentAccount, "currentAccount");
...
__name2(sessionIdentity, "sessionIdentity");
...
__name2(workspaceIdentity, "workspaceIdentity");
...
__name2(consumeLoginCode, "consumeLoginCode");
...
__name2(registerWithPassword, "registerWithPassword");
...
__name2(verifyRegistrationCode, "verifyRegistrationCode");
...
__name2(loginWithPassword, "loginWithPassword");
...
__name2(createDevSession, "createDevSession");
...
__name2(createBuildLaunch, "createBuildLaunch");
...
__name2(checkGameSession, "checkGameSession");
...
__name2(checkGameAccess, "checkGameAccess");
...
__name2(gameAccessForUser, "gameAccessForUser");
...
__name2(requireGameGateSecret, "requireGameGateSecret");
...
__name2(cleanGameBuildKey, "cleanGameBuildKey");
...
__name2(cleanExternalUrl, "cleanExternalUrl");
...
__name2(listPostComments, "listPostComments");
...
__name2(createPostComment, "createPostComment");
...
__name2(deletePostComment, "deletePostComment");
...
__name2(getAccountProfile, "getAccountProfile");
...
__name2(updateAccountProfile, "updateAccountProfile");
...
__name2(accountLinksConfig, "accountLinksConfig");
...
__name2(handleAccountLinkApi, "handleAccountLinkApi");
...
__name2(oauthProviderConfig, "oauthProviderConfig");
...
__name2(startOAuthLink, "startOAuthLink");
...
__name2(readOAuthState, "readOAuthState");
...
__name2(finishGoogleLink, "finishGoogleLink");
...
__name2(finishXLink, "finishXLink");
...
__name2(exchangeOAuthToken, "exchangeOAuthToken");
...
__name2(finishTelegramWidgetLink, "finishTelegramWidgetLink");
...
__name2(linkTelegramCode, "linkTelegramCode");
...
__name2(linkExternalIdentity, "linkExternalIdentity");
...
__name2(handlePostsApi, "handlePostsApi");
...
__name2(listHubPosts, "listHubPosts");
...
__name2(hubPostRowWithCounts, "hubPostRowWithCounts");
...
__name2(hubPostBaseRow, "hubPostBaseRow");
...
__name2(createHubPost, "createHubPost");
...
__name2(updateHubPost, "updateHubPost");
...
__name2(deleteHubPost, "deleteHubPost");
...
__name2(likeHubPost, "likeHubPost");
...
__name2(unlikeHubPost, "unlikeHubPost");
...
__name2(handleCommunityChatApi, "handleCommunityChatApi");
...
__name2(ensurePostSchema, "ensurePostSchema");
...
__name2(tableColumns, "tableColumns");
...
__name2(ensureCommunityChatSchema, "ensureCommunityChatSchema");
...
__name2(listChatMessages, "listChatMessages");
...
__name2(createChatMessage, "createChatMessage");
...
__name2(editChatMessage, "editChatMessage");
...
__name2(deleteChatMessage, "deleteChatMessage");
...
__name2(handleAdminChatApi, "handleAdminChatApi");
...
__name2(listChatModerationQueue, "listChatModerationQueue");
...
__name2(approveQueuedChatMessage, "approveQueuedChatMessage");
...
__name2(dismissQueuedChatMessage, "dismissQueuedChatMessage");
...
__name2(translatePublishedChatMessage, "translatePublishedChatMessage");
...
__name2(translateQueuedChatMessage, "translateQueuedChatMessage");
...
__name2(translateChatBody, "translateChatBody");
...
__name2(chatUserState, "chatUserState");
...
__name2(publicChatUserState, "publicChatUserState");
...
__name2(incrementChatStrike, "incrementChatStrike");
...
__name2(saveChatModerationQueue, "saveChatModerationQueue");
...
__name2(moderateChatMessage, "moderateChatMessage");
...
__name2(localChatModeration, "localChatModeration");
...
__name2(aiChatModeration, "aiChatModeration");
...
__name2(translateWithAi, "translateWithAi");
...
__name2(publicQueuedChatMessage, "publicQueuedChatMessage");
...
__name2(normalizeAiModeration, "normalizeAiModeration");
...
__name2(cleanModerationDecision, "cleanModerationDecision");
...
__name2(cleanModerationCategory, "cleanModerationCategory");
function normalizeModerationText(value) {
  return String(value || "").toLowerCase().replace(/[\u200B-\u200D\uFEFF]/g, "").replace(/\s+/g, " ").trim();
}
__name(normalizeModerationText, "normalizeModerationText");
__name2(normalizeModerationText, "normalizeModerationText");
...
__name2(containsIllegalMinorSexualContent, "containsIllegalMinorSexualContent");
...
__name2(looksLikeSpamText, "looksLikeSpamText");
...
__name2(cleanTargetLanguage, "cleanTargetLanguage");
...
__name2(cleanRoutePart, "cleanRoutePart");
...
__name2(handleAdminUsersApi, "handleAdminUsersApi");
...
__name2(listAdminUsers, "listAdminUsers");
...
__name2(updateUserRole, "updateUserRole");
...
__name2(createSessionResponse, "createSessionResponse");
...
__name2(moonPayPublicConfig, "moonPayPublicConfig");
...
__name2(createMoonPayCheckoutSession, "createMoonPayCheckoutSession");
...
__name2(cancelScheduledMoonPayDowngrade, "cancelScheduledMoonPayDowngrade");
...
__name2(cancelSubscriptionRenewal, "cancelSubscriptionRenewal");
...
__name2(resumeSubscriptionRenewal, "resumeSubscriptionRenewal");
...
__name2(handleMoonPayWebhook, "handleMoonPayWebhook");
...
__name2(applyMoonPayWebhookEvent, "applyMoonPayWebhookEvent");
...
__name2(resolveMoonPayDetails, "resolveMoonPayDetails");
...
__name2(moonPayCheckoutSession, "moonPayCheckoutSession");
...
__name2(grantMoonPayAccess, "grantMoonPayAccess");
...
__name2(endMoonPayAccess, "endMoonPayAccess");
...
__name2(upsertMoonPaySubscription, "upsertMoonPaySubscription");
...
__name2(recordMoonPayPayment, "recordMoonPayPayment");
...
__name2(markMoonPayCheckoutSession, "markMoonPayCheckoutSession");
...
__name2(verifyMoonPayWebhook, "verifyMoonPayWebhook");
...
__name2(matchingMoonPayWebhookToken, "matchingMoonPayWebhookToken");
...
__name2(moonPayWebhookEventId, "moonPayWebhookEventId");
...
__name2(moonPayPayloadDetails, "moonPayPayloadDetails");
...
__name2(moonPayTransactionObject, "moonPayTransactionObject");
...
__name2(moonPayEventType, "moonPayEventType");
...
__name2(moonPaySubscriptionRecordId, "moonPaySubscriptionRecordId");
...
__name2(moonPayEndedStatus, "moonPayEndedStatus");
...
__name2(moonPayPublicPlan, "moonPayPublicPlan");
...
__name2(moonPayHostedUrl, "moonPayHostedUrl");
...
__name2(moonPayConfig, "moonPayConfig");
...
__name2(moonPayWebhookTokens, "moonPayWebhookTokens");
...
__name2(tierForMoonPayPaylink, "tierForMoonPayPaylink");
...
__name2(parseMoonPayAdditionalJSON, "parseMoonPayAdditionalJSON");
...
__name2(moonPayAmountCents, "moonPayAmountCents");
...
__name2(cleanMoonPayNetwork, "cleanMoonPayNetwork");
...
__name2(cleanIsoDate, "cleanIsoDate");
...
__name2(safeHexEqual, "safeHexEqual");
...
__name2(upsertIdentity, "upsertIdentity");
...
__name2(activeSubscription, "activeSubscription");
...
__name2(moonPayCheckoutPlan, "moonPayCheckoutPlan");
...
__name2(currentEffectiveSubscriptionRow, "currentEffectiveSubscriptionRow");
...
__name2(notExpiredSubscriptionForTier, "notExpiredSubscriptionForTier");
...
__name2(activeBlockingSubscriptionForTier, "activeBlockingSubscriptionForTier");
...
__name2(scheduledLowerTierAccess, "scheduledLowerTierAccess");
...
__name2(revokeScheduledLowerTierAccess, "revokeScheduledLowerTierAccess");
...
__name2(activeRenewalCancellation, "activeRenewalCancellation");
...
__name2(insertSubscriptionControl, "insertSubscriptionControl");
...
__name2(supersedeActiveLowerTierAccess, "supersedeActiveLowerTierAccess");
...
__name2(publicScheduledSubscription, "publicScheduledSubscription");
function formatApiDate(value) {
  return value || "the current period end";
}
__name(formatApiDate, "formatApiDate");
__name2(formatApiDate, "formatApiDate");
...
__name2(latestMoonPaySubscription, "latestMoonPaySubscription");
...
__name2(emptySubscription, "emptySubscription");
...
__name2(accountRole, "accountRole");
...
__name2(envAdminEmails, "envAdminEmails");
...
__name2(isEnvAdminEmail, "isEnvAdminEmail");
...
__name2(canReadVisibility, "canReadVisibility");
...
__name2(firstMediaUrl, "firstMediaUrl");
...
__name2(replacePostMedia, "replacePostMedia");
...
__name2(normalizeMediaList, "normalizeMediaList");
...
__name2(cleanMediaType, "cleanMediaType");
...
__name2(cleanPostStatus, "cleanPostStatus");
...
__name2(cleanPostVisibility, "cleanPostVisibility");
function cleanLongText(value, maxLength) {
  return String(value || "").trim().replace(/\r\n/g, "\n").replace(/[\t ]+\n/g, "\n").slice(0, maxLength);
}
__name(cleanLongText, "cleanLongText");
__name2(cleanLongText, "cleanLongText");
...
__name2(writeModerationLog, "writeModerationLog");
...
__name2(isMissingSchemaError, "isMissingSchemaError");
...
__name2(moonPayMigrationMissingResponse, "moonPayMigrationMissingResponse");
...
__name2(subscriptionControlsMigrationMissingResponse, "subscriptionControlsMigrationMissingResponse");
function redirectResponse(location, status = 302) {
  return new Response(null, { status, headers: { location } });
}
__name(redirectResponse, "redirectResponse");
__name2(redirectResponse, "redirectResponse");
...
__name2(randomNumericCode, "randomNumericCode");
...
__name2(sha256Bytes, "sha256Bytes");
...
__name2(hmacSha256HexWithKey, "hmacSha256HexWithKey");
...
__name2(escapeEmailHtml, "escapeEmailHtml");
...
__name2(cleanDisplayName, "cleanDisplayName");
...
__name2(safeFallbackDisplayName, "safeFallbackDisplayName");
...
__name2(reservedDisplayNameReason, "reservedDisplayNameReason");
...
__name2(normalizeReservedDisplayName, "normalizeReservedDisplayName");
...
__name2(cleanPostSlug, "cleanPostSlug");
...
__name2(validateEmailPassword, "validateEmailPassword");
...
// ../../../home/oai/.npm/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-dev-util.ts
...
// .wrangler/tmp/pages-2AuX7t/dq4m09ohbfl.js
...
// .wrangler/tmp/bundle-BGyP0g/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-BGyP0g/middleware-loader.entry.ts
